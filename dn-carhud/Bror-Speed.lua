...
local fuelColorOver = {255, 96, 96}         -- Color used to display fuel when good
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                if ShouldUseMetricMeasurements() then
                    ...
                    drawTxt("KM", 2, speedColorText, 0.4, screenPosX + 0.030, screenPosY + 0.018)
                else
                    -- Get vehicle speed in MPH and draw speedometer
                    local speed = currSpeed*2.23694
                    local speedColor = (speed >= speedLimit) and speedColorOver or speedColorUnder
                    drawTxt(("%.3d"):format(math.ceil(speed)), 2, speedColor, 0.8, screenPosX + 0.000, screenPosY + 0.000)
                    drawTxt("", 2, speedColorText, 0.4, screenPosX + 0.030, screenPosY + 0.018)
                end
                ...
                drawTxt("Benzin", 2, fuelColorText, 0.4, screenPosX + 0.085, screenPosY + 0.018)
                ...
                if vehicleClass ~= 8 then
                    ...
                    drawTxt("  Sele", 2, seatbeltColor, 0.4, screenPosX + 0.080, screenPosY + 0.048)
                end
            end
        end
    end
...
Citizen.CreateThread(function()
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            timeText = ("%.2d"):format((hour == 0) and 12 or hour) .. ":" .. ("%.2d"):format( minute) .. ((hour < 12) and " KL." or " KL.")
